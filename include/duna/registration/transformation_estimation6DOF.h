...
namespace duna
{
    ...
    {
    public:
        using Ptr = std::shared_ptr<TransformationEstimator6DOF<PointSource, PointTarget, Scalar>>;
        using ConstPtr = std::shared_ptr<const TransformationEstimator6DOF<PointSource, PointTarget, Scalar>>;
