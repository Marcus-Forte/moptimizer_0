...
namespace duna
{
    /* Numerical Differentiation cost function module. Computes numerical derivatives when computing hessian. Dynamic size parameters and function outputs. */
    ...
    public:
        ...
        CostFunctionNumericalDynamic(ModelPtr model, int num_parameters, int num_outputs, int num_residuals) : CostFunctionNumerical<Scalar>(model, num_residuals), 
        num_parameters_(num_parameters), num_outputs_(num_outputs)
        {}

        CostFunctionNumericalDynamic(ModelPtr model, int num_parameters, int num_outputs ) : CostFunctionNumerical<Scalar>(model), 
        num_parameters_(num_parameters), num_outputs_(num_outputs)
        {}
