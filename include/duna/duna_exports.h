...
#define DUNA_OPTIMIZER_DEPRECATED_EXPORT \
  DUNA_OPTIMIZER_EXPORT DUNA_OPTIMIZER_DEPRECATED
#endif

#ifndef DUNA_OPTIMIZER_DEPRECATED_NO_EXPORT
#define DUNA_OPTIMIZER_DEPRECATED_NO_EXPORT \
  DUNA_OPTIMIZER_NO_EXPORT DUNA_OPTIMIZER_DEPRECATED
#endif
