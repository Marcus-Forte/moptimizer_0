...
TYPED_TEST(RegistrationPoint2Point, Translation) {
  ...
  auto cost =
      new duna::CostFunctionNumerical<TypeParam, 6, 3>(scan_matcher_model, this->source->size());
...
TYPED_TEST(RegistrationPoint2Point, RotationPlusTranslationDynamic) {
  ...
  auto cost = new duna::CostFunctionAnalyticalDynamic<TypeParam>(scan_matcher_model, 6, 3,
                                                                 this->source->size());
